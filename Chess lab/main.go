...
func main() {
	...
	if s[Casella{r2, 2}].colore {
		fmt.Println("Ha vinto il nero")
	} else {
		fmt.Println("Ha vinto il bianco")
	}
}

//debugMove esegue una mossa, visualizza la tastiera, e mostra il pezzo mosso e quello (eventualmente) rimosso
...
//complex(real FloatType, imag FloatType) Stampa una linea lunga with
...
// readMove legge una mossa nella forma
// r1,c1 r2,c2
